<template>
  <div>
    <label class="swap swap-rotate">
      ...
      <input type="checkbox" class="theme-controller" @change="toggleTheme" v-model="isDarkMode" />
...
const toggleTheme = () => {
  document.documentElement.setAttribute('data-theme', isDarkMode.value ? 'dark' : 'bumblebee');
}

onMounted(() => {
  // Set initial theme to bumblebee
